...
Program  : Program Number 5 - leadsmanager.php
Due Date : 4/8/2018
...
<html lang="en">
    <head>
        ...
        <title> Massuh, Christian, Program 5 - Leads Manager</title>
    ...
    <body>
        ...
        <form method="post" action="leadsmanagercontroller.php">
            ...
            <table style="width: 25%; margin: 0px auto; text-align: center">
                <tr>           
                    <td><input type="submit"    name="First"    value="FIRST"></td>
                    <td><input type="submit"    name="Next"     value="NEXT"></td>
                    <td><input type="submit"    name="Previous" value="PREVIOUS"></td>
                    <td><input type="submit"    name="Last"     value="LAST"></td>
                    <td><input type="hidden"    name="location" value="<?php echo $location; ?>"</td>
