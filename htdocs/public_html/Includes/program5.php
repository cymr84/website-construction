...
Program  : Program Number 5 - program5.php
Due Date : 4/8/2018
...
<html lang="en">
    <head>
        ...
        <title> Massuh, Christian, Program 5</title>
        ...
        <form method="post" action="controller5.php">
            ...
            <table style="width: 50%; margin: 0px auto; text-align: center">
                <tr>           
                    ...
                    <td><input type="submit" name="Leads"  value="Leads"></td>
                    <td><input type="submit" name="Leads_Manager"  value="Leads Manager"></td>
