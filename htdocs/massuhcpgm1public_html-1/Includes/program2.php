            ...
            <table style="width: 60%; margin: 0px auto;">
                <tr>
                    ...
                    <td style="text-align: right"> 
                        LA Zoo <input type="checkbox" name="LAZoo" 
                               <?php if ($LAZoo == "LA Zoo") echo checked;?>    value="LA Zoo" >  </td>
                    <td>
                    ...
                    <td >Animals &nbsp; </td>
                    <td text-align: left> 
                        <input type="radio" <?php if ($Animals == "Horses")   echo "checked"; ?>
                               name="Animals1" value="Horses" checked > Horses &nbsp; &nbsp; </td>
                    <td text-align: left>
